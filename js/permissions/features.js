export const Features = {
    ...
    'follow-up-pipelines': { id: 'pipelines', name: 'Follow-Up Pipelines', requiredPlan: 'pro', badge: 'PRO', icon: '<path stroke-linecap="round" stroke-linejoin="round" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"/>' },
...
export const SidebarFeatures = [
    // FREE
    'dashboard', 'upcoming-meetings', 'ai-research-briefs', 'outreach-generator',
    // PRO
    'follow-up-pipelines', 'relationship-intelligence', 'priority-sync-queues',
    // TEAM
